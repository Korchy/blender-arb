...
from . import accurate_render_border_ops
from . import accurate_render_border_panel
from .addon import Addon


bl_info = {
    'name': 'accurate_render_border',
    'category': 'All',
...
def register():
    if not Addon.dev_mode():
        ...
        accurate_render_border_ops.register()
        accurate_render_border_panel.register()
    else:
...
def unregister():
    if not Addon.dev_mode():
        accurate_render_border_panel.unregister()
        accurate_render_border_ops.unregister()
